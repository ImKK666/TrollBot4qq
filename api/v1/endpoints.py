...
from config import (
    ...
    DIGESTION_BUFFER_SIZE, 
    RECENT_MESSAGES_BUFFER_SIZE,
    QUICK_REPLY_COOLDOWN_SECONDS,
    BOT_QQ_ID,
    BOT_NICKNAME
)
# 导入新的共享状态模块
from core.state import (
    ...
    recent_contexts_by_group, 
    last_speech_timestamps
)
from core.llm_service import digest_messages_in_background, generate_fast_track_reply
...
async def process_fast_track_message(target_message: dict, recent_history: List[dict]):
    ...
    if reply_text:
        ...
        bot_message = {
            ...
            "group_id": group_id,
            "user_id": BOT_QQ_ID,
            "sender": {"user_id": BOT_QQ_ID, "nickname": BOT_NICKNAME, "role": "member"},
